# Project Flask-05 : Handling SQL with Flask Web Application

Purpose of the this project is to give the introductory knowledge of how to handle forms, how to connect to database and how to use sql within Flask web application on Amazon Linux 2 EC2 instance. 
...
## Part 1 - Write a Sample Web Application with SQLite and database implementation
