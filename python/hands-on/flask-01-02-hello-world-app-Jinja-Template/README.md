# Flask-01-02 : Creating First Flask Application - Hello World and basic usage of Jinja Templates

Purpose of the this project is to give the quick introductory knowledge of how to create a Flask web application on local.
